angular.module('starter.controllers', [])
  ...
  .controller('postCtrl', ['$window', '$ionicPlatform', '$rootScope', '$scope', '$ionicScrollDelegate', '$ionicModal', '$http',
    function($window, $ionicPlatform, $rootScope, $scope, $ionicScrollDelegate, $ionicModal, $http) {
      var userInput = { 'title': '', 'content': '' };

      $rootScope.files = [];
      $rootScope.appName = 'Ensemble에 게시';
      $rootScope.postData = userInput;
      ...
      $rootScope.onClickPost = function () {
        var uploadUrl = "http://127.0.0.1:5000/postingUpload";
        var fd = new FormData();
        var len = document.getElementsByName('fileInput').length;

        console.log('postCtrl');
        fd.append('title', $rootScope.postData.title);
        fd.append('content', $rootScope.postData.content);
        console.log($rootScope.postData.title);
      ...
      $rootScope.changeFileValue = function () {
